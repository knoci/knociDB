...
- 🔌 **gRPC support** client-stream Batch, server-stream Scan, optional auth/TLS
...
🔌 For gRPC usage, see `examples/gRPC` for an interactive client and a configurable server.
```bash
